...
export default function Home() {
  return (
    <main className=" w-full px-4 bg-[#111010] ">
      ...
      <div className="flex flex-col  items-center  space-y-6 ">
        ...
        <h1>
          ...
          Poland with over 9 years of experience focusing on user experience and
          design systems to creating a user-centered design in SaaS products.
