    ...
    <main className="flex flex-col items-center p-6 space-y-8">
      ...
      <Card className="w-full max-w-2xl">
        ...
        <CardContent className="space-y-4">
          ...
          <p>
    I&rsquo;m a final-year student at the University of Limpopo, dedicated to pursuing a BSc in Mathematical Sciences with  focus on Computer Sciences and Applied Mathematics.
</p>
<p>
    With recent interests in High-Performance Computing (HPC), I&rsquo;ve been focusing on improving my system administration skills and scripting abilities. At the same time, I&rsquo;ve been working on web development, utilizing frameworks such as Next.js and Express.js to explore new avenues in the digital realm.
</p>
